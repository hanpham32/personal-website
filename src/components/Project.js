        ...
        <div className="my-2 flex flex-row-reverse w-full lg:col-span-1">
          <a
            ...
            className={
              demo == ""
                ? "hidden"
                : "flex justify-center items-center cursor-pointer bg-demoBtn w-16 h-8 rounded-full transform hover:scale-110 mr-2 hover:no-underline hover:text-milkyWhite"
            }
          >
            <span>Demo</span>
          </a>
          <a
            href={source}
            target="_blank"
            className="w-8 h-8 block mx-2 cursor-pointer transform hover:scale-110"
          >
