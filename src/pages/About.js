        ...
        <div classname="flex justify-center lg:col-span-1">
          ...
          <div className="flex justify-center mt-2">
            <a href="https://github.com/hanpham32" target="_blank">
              <img src={GITHUB} alt="github-icon" className="w-8 h-8 mx-2 mb-2 transform hover:scale-110"></img>
            </a>
            <a href="https://www.linkedin.com/in/hansopham/" target="_blank">
              <img src={LINKEDIN} alt="linkedin-icon" className="w-8 h-8 mx-2 mb-2 transform hover:scale-110"></img>
            </a>
          </div>
        </div>
        <div className="lg:col-span-4">
          <p className="text-lightGrey text-xl">
            I am a college freshman from the Seattle area. I either
